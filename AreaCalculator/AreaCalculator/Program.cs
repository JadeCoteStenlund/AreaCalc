        ...
        static void Main(string[] args)
        {
            ...
            while (runApp == true)
            {
                ...
                else
                {
                    ...
                    {                        
                        switch (usersInput) // SWITH CASE FOR ALL SUPPORTED SHAPES TO CALCULATE THE AREA
                        {
                            ...
                            default:
                                ...
                                Console.Write("ERROR");
                                Console.ForegroundColor = ConsoleColor.White;
                                Console.WriteLine(": Invalid Input\n"); shapeSelect = false; break; // Setting the shapeSelect to false to avoid infinite loops.
                        }
                    }
                }
            }
